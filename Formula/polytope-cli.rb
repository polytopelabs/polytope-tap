class PolytopeCli < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://polytope-cli-releases.s3.eu-north-1.amazonaws.com/pt-0.1.26-macos-amd64.gzip"
      sha256 "4b04e30c34f67e27c4d65892d4b3409758a1c55268b44763259dfab346651636"
    elsif Hardware::CPU.arm?
      url "https://polytope-cli-releases.s3.eu-north-1.amazonaws.com/pt-0.1.26-macos-arm64.gzip"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://polytope-cli-releases.s3.eu-north-1.amazonaws.com/pt-0.1.26-linux-amd64.gzip"
