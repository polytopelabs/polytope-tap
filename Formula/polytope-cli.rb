class PolytopeCli < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://polytope-cli-releases.s3.eu-north-1.amazonaws.com/pt-0.1.23-macos-amd64.gz2"
      sha256 "ec974ff87b8805f4b25fbbc7d252311971f5fbb29d96d8d807c70ed3032635fa"
    elsif Hardware::CPU.arm?
      url "https://polytope-cli-releases.s3.eu-north-1.amazonaws.com/pt-0.1.23-macos-arm64.gz2"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://polytope-cli-releases.s3.eu-north-1.amazonaws.com/pt-0.1.23-linux-amd64.gz2"
